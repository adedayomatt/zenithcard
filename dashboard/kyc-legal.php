											...
											<form action="<?php $_PHP_SELF ?>" method="POST">
												...
												<h2 class="primary-color text-center"><i class="fas fa-briefcase"></i> KYC Legal Entity</h2>
											...
											<div class="text-center">
												<h5 class="primary-color">Our crowdsale starts <em style="text-decoration: underline">April 23rd, 2018.</em> In order to participate, please fill the KYC form below</h5>
												<p class="grey">This will ensure the highest legal standards and safety procedures. We promise your personal data will stay confidential and secure with us.</p>
											</div>												
												...
												<input type="hidden" name="user_id" value="<?php echo $user->id ?>">
													...
													<div class="warning-container">
														...
														<p>Be careful while filling the information, once a field is filled and submitted, they are not editable unless they were empty. This is for security reason</p>
													</div>
													
												
												<div class="kyc-section f7-bg" id="personal-info">
												<h3 class="primary-color">COMPANY INFORMATION</h3>
												
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="form-group">
															<label for="company_name">Full Company Name</label>
															<input type="text" name="company_name" class="form-control" placeholder="Full Name of Company" value="<?php echo ($myKYC->companyName == '' ? '': $myKYC->companyName) ?>" <?php echo ($myKYC->companyName == '' ? '': 'readonly') ?>>
														</div>
													</div>
													
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														<div class="form-group">
															<label for="company_address">Registered Company Address</label>
															<input type="text" name="company_address" class="form-control" placeholder="Company Full Address" value="<?php echo ($myKYC->companyAddress == '' ? '': $myKYC->companyAddress) ?>" <?php echo ($myKYC->companyAddress == '' ? '': 'readonly') ?>>
														</div>
													</div>
													...
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														<div class="form-group">
															...
															<input type="text" name="business_address" class="form-control" placeholder="Business Address (**If different from the registered company address)" value="<?php echo ($myKYC->businessAddress == '' ? '': $myKYC->businessAddress) ?>" <?php echo ($myKYC->businessAddress == '' ? '': 'readonly') ?> >
														</div>
													</div>
													...
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														<div class="form-group">
															...
															<input type="text" name="reg_number" class="form-control" placeholder="Company Registration Number" value="<?php echo ($myKYC->regNumber == '' ? '': $myKYC->regNumber) ?>" <?php echo ($myKYC->regNumber == '' ? '': 'readonly') ?> >
														</div>
													</div>

													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														<div class="form-group">
															<label for="legal_rep">Full Name of Legal Representative</label>
															<input type="text" name="legal_rep" class="form-control" placeholder="Your city" value="<?php echo ($myKYC->legalRep == '' ? '': $myKYC->legalRep) ?>" <?php echo ($myKYC->legalRep == '' ? '': 'readonly') ?>>
														</div>
													</div>
													...
													<div class="row" id="back-id">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<?php
																if($myKYC->certificate == ''){
															?>
																<iframe src="upload.php?kyc=legal&id=<?php echo $user->id ?>&photo=certificate-of-incorporation&photo_id=<?php echo $user->firstName.'-'.$user->lastName.'-'.$user->id.'-certificate-of-incorporation' ?>"frameborder="0"></iframe>
															<?php
																}
																else{
																	?>
																<img src="../images/KYC/KYCL/<?php echo $myKYC->certificate ?>" width="300px" height="auto">	
																	<?php
																}
																?>
														</div>
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="form-group">
																<div class="<?php echo $myKYC->certificate == '' ? '' : 'disabled'?>">
																	<label class="primary-color">Criteria For Certificate of Incorporation</label>
																	<ul>
																		<li class="doc-criteria-list"><i class="fas fa-check-circle"></i>  Entire file must be visible</li>
																		<li class="doc-criteria-list"><i class="fas fa-check-circle"></i>  File must be clear and easy to read </li>
																		<li class="doc-criteria-list"><i class="fas fa-check-circle"></i>  Format: JPG, JPEG OR PNG </li>
																	</ul>
																</div>
															</div>
														</div>
												...
												<!--------------------------->
												<div class="kyc-section f7-bg" id="personal-info">
												<h3 class="primary-color">LEGAL REPRESENTATIVE INFORMATION</h3>
													...
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														<div class="form-group">
															...
															if($myKYC->idType == ''){
																...
																<input type="hidden" name="id_type" value="<?php echo $myKYC->idType ?>">
															<?php
															}
															?>
														</div>
												...
												<div class="kyc-section f7-bg" id="id_document_photo">
													...
													<div class="row" id="front-id">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															...
															?>
																<iframe src="upload.php?kyc=legal&id=<?php echo $user->id ?>&photo=id-front&photo_id=<?php echo $user->firstName.'-'.$user->lastName.'-'.$user->id.'-id-front' ?>" frameborder="0"></iframe>
															<?php
																}
																else{
																	?>
																<img src="../images/KYC/KYCL/<?php echo $myKYC->idPhotoFront ?>" width="300px" height="auto">	
																	<?php
																}
																?>
														</div>
													...
													<div class="row" id="back-id">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															...
															?>
																<iframe src="upload.php?kyc=legal&id=<?php echo $user->id ?>&photo=id-back&photo_id=<?php echo $user->firstName.'-'.$user->lastName.'-'.$user->id.'-id-back' ?>"frameborder="0"></iframe>
															<?php
																}
																else{
																	?>
																<img src="../images/KYC/KYCL/<?php echo $myKYC->idPhotoBack ?>" width="300px" height="auto">	
																	<?php
																}
																?>
														</div>
												...
												<div class="kyc-section f7-bg" id="ultilty-bill-photo">
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
															...
															?>
																<iframe src="upload.php?kyc=legal&id=<?php echo $user->id ?>&photo=ultility-bill&photo_id=<?php echo $user->firstName.'-'.$user->lastName.'-'.$user->id.'-ultilty-bill' ?>" frameborder="0"></iframe>
															<?php
																}
																else{
																	?>
																<img src="../images/KYC/KYCL/<?php echo $myKYC->ultilityBillPhoto ?>" width="300px" height="auto">	
																	<?php
																}
																?>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center">
															<?php
																if($myKYC->selfie == ''){
															?>
																<iframe src="upload.php?kyc=legal&id=<?php echo $user->id ?>&photo=selfie&photo_id=<?php echo $user->firstName.'-'.$user->lastName.'-'.$user->id.'-selfie' ?>" frameborder="0"></iframe>
															<?php
																}
																else{
																	?>
																<img src="../images/KYC/KYCL/<?php echo $myKYC->selfie ?>" width="300px" height="auto">	
																	<?php
																}
																?>
														</div>
												...
												<div class="terms-of-sale" style="max-height: 500px;overflow:auto">
												<?php
												/*try{
													$filename = 'terms-of-service.txt';
													$termsFile = fopen($filename, "r");
													echo  fread($termsFile,filesize($filename));
													fclose($termsFile);
												}
												catch($e){
													echo "Couldn't reach the terms of sales at the moment";
												}*/
												?>
												</div>
											...
											<div class="warning-container">
												<i class="fas fa-exclamation-triangle"></i>
												<p>Be sure that the information provided are correct, once a field is filled and submitted, they are not editable unless they were empty. This is for security reason</p>
											</div>
													
													<input type="submit" name="submit_KYC_legal" value="Submit" class="btn">
												</div>
											</form>
